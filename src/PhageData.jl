...
if haskey(ENV, "PHAGEDATAPATH")
    ...
    error("Please set PHAGEDATAPATH environment variable (or ENV[\"PHAGEDATAPATH\"] within Julia) with a directory to place DMS data. See README.md for more details.")
end
